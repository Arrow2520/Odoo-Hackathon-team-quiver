...
from backend.enums import DriverStatus
...
def get_dispatchable_drivers(db: Session = Depends(get_db)):
    """Drivers eligible for a new trip: Available status AND non-expired license."""
    today = date.today()
